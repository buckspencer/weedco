...
function weedco_scripts() {
	wp_enqueue_style( 'weedco-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'weedco-style', 'rtl', 'replace' );

	wp_enqueue_script( 'weedco-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
